#ifndef _IMX258SUNNYAF_H
#define _IMX258SUNNYAF_H

#include <linux/ioctl.h>
//#include "kd_imgsensor.h"

#define IMX258SUNNYAF_MAGIC 'A'
...
#define IMX258SUNNYAFIOC_G_MOTORINFO _IOR(IMX258SUNNYAF_MAGIC,0,stIMX258SUNNYAF_MotorInfo)

#define IMX258SUNNYAFIOC_T_MOVETO _IOW(IMX258SUNNYAF_MAGIC,1,unsigned long)

#define IMX258SUNNYAFIOC_T_SETINFPOS _IOW(IMX258SUNNYAF_MAGIC,2,unsigned long)

#define IMX258SUNNYAFIOC_T_SETMACROPOS _IOW(IMX258SUNNYAF_MAGIC,3,unsigned long)
#ifdef LensdrvCM3
#define IMX258SUNNYAFIOC_G_MOTORMETAINFO _IOR(IMX258SUNNYAF_MAGIC,4,stIMX258SUNNYAF_MotorMETAInfo)
#endif
