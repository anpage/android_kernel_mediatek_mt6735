...
#define HI842AFIOC_G_MOTORINFO _IOR(HI842AF_MAGIC, 0, stHI842AF_MotorInfo)

#define HI842AFIOC_T_MOVETO _IOW(HI842AF_MAGIC, 1, u32)

#define HI842AFIOC_T_SETINFPOS _IOW(HI842AF_MAGIC, 2, u32)

#define HI842AFIOC_T_SETMACROPOS _IOW(HI842AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define HI842AFIOC_G_MOTORMETAINFO _IOR(HI842AF_MAGIC, 4, stHI842AF_MotorMETAInfo)
#endif
