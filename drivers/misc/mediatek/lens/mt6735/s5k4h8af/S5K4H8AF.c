...
#define AF_DRVNAME "S5K4H8AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x1b
#define PLATFORM_DRIVER_NAME "lens_actuator_s5k4h8af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_s5k4h8af"
...
inline static int getAFInfo(__user stS5K4H8AF_MotorInfo * pstMotorInfo)
{
    stS5K4H8AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stS5K4H8AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stS5K4H8AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stS5K4H8AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stS5K4H8AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case S5K4H8AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stS5K4H8AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case S5K4H8AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stS5K4H8AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case S5K4H8AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case S5K4H8AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case S5K4H8AFIOC_T_SETMACROPOS :
...
static int __init S5K4H8AF_i2C_init(void)
{
...
static void __exit S5K4H8AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

/* ////////////////////////////////////////////////////////////// */
long S5K4H8AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
/* 3.Only called once on last time. */
/* Q1 : Try release multiple times. */
int S5K4H8AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void S5K4H8AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
// module_init(S5K4H8AF_i2C_init);
// module_exit(S5K4H8AF_i2C_exit);

// MODULE_DESCRIPTION("S5K4H8AF lens module driver");
