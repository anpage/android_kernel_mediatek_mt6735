...
extern int LM3642_write_reg_ext(u8 reg, u8 val);
...
static int FL_Enable(void)
{
 ...
 //   mt_set_gpio_out(FLASH_GPIO_ENE,GPIO_OUT_ONE);
	...
	if(gDuty ==0){
		LM3642_write_reg_ext(0x05, 0x0A);	//torch  23.04mA , flash 1030.85mA
		LM3642_write_reg_ext(0x07, 0x7F);   //led1 on,led2 off
		LM3642_write_reg_ext(0x01, 0x02);     //torch
	}
	else if(gDuty ==1){
		LM3642_write_reg_ext(0x05, 0x1A);	//torch 46.48mA , flash 1030.85mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);     //torch
	}
	else	 if(gDuty ==2){
		LM3642_write_reg_ext(0x05, 0x2A);	//torch  69.91mA , flash 1030.85mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);     //torch
	}
	else	 if(gDuty ==3){
		LM3642_write_reg_ext(0x05, 0x3A);	//torch  93.35mA , flash 1030.85mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);     //torch
	}
	else	 if(gDuty ==4){
		LM3642_write_reg_ext(0x05, 0x4A);	//torch 116.79mA , flash 1030.85mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);     //torch
	}
	else if(gDuty ==5){
		LM3642_write_reg_ext(0x05, 0x52);   //torch 140.23mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);	//torch
	}
	else if(gDuty ==6){
		LM3642_write_reg_ext(0x05, 0x66);	//torch 163.66mA
		LM3642_write_reg_ext(0x07, 0x7F);
		LM3642_write_reg_ext(0x01, 0x02);    //FLASH
	}
	else
	{
...
static int FL_Disable(void)
{
   ...
   // mt_set_gpio_out(FLASH_GPIO_ENE,GPIO_OUT_ONE);
    ...
    LM3642_write_reg_ext(0x01, 0x00); 
