...
#include "ov5670mipiraw_cmk_Camera_Sensor_para.h"
#include "ov5670mipiraw_cmk_CameraCustomized.h"

//extern kal_uint16 ov5670_write_cmos_sensor(kal_uint32 addr, kal_uint32 para);
//extern kal_uint16 ov5670_read_cmos_sensor(kal_uint32 addr);
...
signed char check_cmk_MID_ov5670(signed char index);
