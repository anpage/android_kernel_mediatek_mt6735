...
extern signed char check_sunwin_MID_ov5670(signed char index);
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {				
				...
				if( 0==check_sunwin_MID_ov5670(0) )
				{
...
static kal_uint32 open(void)
{
	...
	sensor_init();
  otp_update_wb_sunwin_ov5670(0x149, 0x153);//raoxuezhen add sanyingxing typical for 5222 front camera
