...
UINT32 S5K3M2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);  //yangchen add 
UINT32 OV5648MIPISensorInit_darling(PSENSOR_FUNCTION_STRUCT *pfFunc);    //yangchen add 
UINT32 OV5648MIPISensorInit_sunwin(PSENSOR_FUNCTION_STRUCT *pfFunc);    //yangchen add 
