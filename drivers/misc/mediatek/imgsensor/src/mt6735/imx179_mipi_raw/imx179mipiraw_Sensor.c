 ...
 kal_uint16 IMX179MIPI_read_cmos_sensor(kal_uint32 addr)
{
 ...
 void IMX179MIPI_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
    kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
...
static void set_dummy(void)
{
    ...
    IMX179MIPI_write_cmos_sensor(0x0340, (imgsensor.frame_length >>8) & 0xFF);
    IMX179MIPI_write_cmos_sensor(0x0341, imgsensor.frame_length & 0xFF);	
    IMX179MIPI_write_cmos_sensor(0x0342, (imgsensor.line_length >>8) & 0xFF);
    IMX179MIPI_write_cmos_sensor(0x0343, imgsensor.line_length & 0xFF);
...
{
    return (((IMX179MIPI_read_cmos_sensor(0x0002)&&0x0f)<<8)  | (IMX179MIPI_read_cmos_sensor(0x0003)) );;
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	write_cmos_sensor_8(0x0104, 0x01); 
	IMX179MIPI_write_cmos_sensor(0x0204, (reg_gain>>8)& 0xFF);
	IMX179MIPI_write_cmos_sensor(0x0205, reg_gain & 0xFF);
	write_cmos_sensor_8(0x0104, 0x00); 	
	return gain;
}	/*	set_gain  */
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
    ...
    if (imgsensor.ihdr_en) {
        ...
        IMX179MIPI_write_cmos_sensor(0x380e, imgsensor.frame_length >> 8);
        IMX179MIPI_write_cmos_sensor(0x380f, imgsensor.frame_length & 0xFF);

        IMX179MIPI_write_cmos_sensor(0x3502, (le << 4) & 0xFF);
        IMX179MIPI_write_cmos_sensor(0x3501, (le >> 4) & 0xFF);
        IMX179MIPI_write_cmos_sensor(0x3500, (le >> 12) & 0x0F);

        IMX179MIPI_write_cmos_sensor(0x3508, (se << 4) & 0xFF);
        IMX179MIPI_write_cmos_sensor(0x3507, (se >> 4) & 0xFF);
        IMX179MIPI_write_cmos_sensor(0x3506, (se >> 12) & 0x0F);
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	iTemp = IMX179MIPI_read_cmos_sensor(0x0101);
...
static void sensor_init(void)
{
	...
	//IMX179MIPI_write_cmos_sensor(0x0101, 0x01); 		
	...
	IMX179MIPI_write_cmos_sensor(0x3302, 0x01);

     #ifdef IMX179_USE_OTP
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]IMX179MIPI_Sensor_Init function,imx179_update_awb_gain\n");
...
static void preview_setting(void)
{
	...
	//IMX179MIPI_write_cmos_sensor(0x0103, 0x01);//SW reset		 		   
	IMX179MIPI_write_cmos_sensor(0x0202, 0x09); //0x0202, 0x09		 
	IMX179MIPI_write_cmos_sensor(0x0203, 0xAD);//(0x0203, 0xcc)
	//PLL setting
	IMX179MIPI_write_cmos_sensor(0x0301, 0x05); 		 
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x030B, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x030C, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x030D, 0xA0); //(0x030D, 0xA2)
	IMX179MIPI_write_cmos_sensor(0x030E, 0x01);
	...
	IMX179MIPI_write_cmos_sensor(0x4109, 0x7C);
        ...
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]preview_setting function,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
...
static void capture_setting(kal_uint16 currefps)
{
	...
	{ //24fps for PIP //@@full_132PCLK_24.75
	 //5.1.2 FQPreview 3280x2464 30fps 24M MCLK 4lane 204.8Mbps/lane
		...
		IMX179MIPI_write_cmos_sensor(0x030B, 0x01); 		 
		IMX179MIPI_write_cmos_sensor(0x030C, 0x00); 		 
		IMX179MIPI_write_cmos_sensor(0x030D, 0x80); //(0x030D, 0xA2)
		IMX179MIPI_write_cmos_sensor(0x030E, 0x01);
		...
		IMX179MIPI_write_cmos_sensor(0x3089, 0x4F); 		 
		IMX179MIPI_write_cmos_sensor(0x3309, 0x9A); 		 
		IMX179MIPI_write_cmos_sensor(0x3344, 0x4F);//(0x3344, 0x57)		 
		IMX179MIPI_write_cmos_sensor(0x3345, 0x1F); 		 
		IMX179MIPI_write_cmos_sensor(0x3362, 0x0A); 		 
		IMX179MIPI_write_cmos_sensor(0x3363, 0x0A); 		 
		IMX179MIPI_write_cmos_sensor(0x3364, 0x00); 		
		IMX179MIPI_write_cmos_sensor(0x3368, 0x18); 		 
		IMX179MIPI_write_cmos_sensor(0x3369, 0x00); 		 
		IMX179MIPI_write_cmos_sensor(0x3370, 0x6F);// (0x3370, 0x77)		 	 
		IMX179MIPI_write_cmos_sensor(0x3371, 0x27);//(0x3371, 0x2F)             
		IMX179MIPI_write_cmos_sensor(0x3372, 0x47);             
		IMX179MIPI_write_cmos_sensor(0x3373, 0x27);             
		IMX179MIPI_write_cmos_sensor(0x3374, 0x27);             
		IMX179MIPI_write_cmos_sensor(0x3375, 0x27);             
		IMX179MIPI_write_cmos_sensor(0x3376, 0x8F);             
		IMX179MIPI_write_cmos_sensor(0x3377, 0x37);             
		IMX179MIPI_write_cmos_sensor(0x33C8, 0x00);             
        ...
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]capture_setting function,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
		IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
	...
	{ //D1 15fps for PIP //@@full_132PCLK_24.75
		...
		//IMX179MIPI_write_cmos_sensor(0x0101, 0x00); 
		//IMX179MIPI_write_cmos_sensor(0x0103, 0x01);//SW reset		 		   
		IMX179MIPI_write_cmos_sensor(0x0202, 0x7C); //0x0202, 0x09		 
		IMX179MIPI_write_cmos_sensor(0x0203, 0x7C);//(0x0203, 0xcc)
		//PLL setting
		IMX179MIPI_write_cmos_sensor(0x0301, 0x2F); 		 
		IMX179MIPI_write_cmos_sensor(0x0303, 0x2F); 		 
		IMX179MIPI_write_cmos_sensor(0x0305, 0x2F); 		 
		IMX179MIPI_write_cmos_sensor(0x0309, 0x9F); 		 
		IMX179MIPI_write_cmos_sensor(0x030B, 0x37); 		 
		IMX179MIPI_write_cmos_sensor(0x030C, 0x4F); 		 
		IMX179MIPI_write_cmos_sensor(0x030D, 0x4F); //(0x030D, 0xA2)
		IMX179MIPI_write_cmos_sensor(0x030E, 0x01);
		
		IMX179MIPI_write_cmos_sensor(0x0340, 0x0A);//(0x0340, 0x09)
		IMX179MIPI_write_cmos_sensor(0x0341, 0x4C); 		 
		IMX179MIPI_write_cmos_sensor(0x0342, 0x0D); 		
		IMX179MIPI_write_cmos_sensor(0x0343, 0x70);//(0x0343, 0x0D) 		 
		IMX179MIPI_write_cmos_sensor(0x0344, 0x00); 		 
		IMX179MIPI_write_cmos_sensor(0x0345, 0x00); 		 
		...
		IMX179MIPI_write_cmos_sensor(0x3089, 0x4F); 		 
		IMX179MIPI_write_cmos_sensor(0x3309, 0x9A); 		 
		IMX179MIPI_write_cmos_sensor(0x3344, 0x37);//(0x3344, 0x57)		 
		IMX179MIPI_write_cmos_sensor(0x3345, 0x1F); 		 
		IMX179MIPI_write_cmos_sensor(0x3362, 0x0A); 		 
		IMX179MIPI_write_cmos_sensor(0x3363, 0x0A); 		 
		IMX179MIPI_write_cmos_sensor(0x3364, 0x00); 		
		IMX179MIPI_write_cmos_sensor(0x3368, 0x18); 		 
		IMX179MIPI_write_cmos_sensor(0x3369, 0x00); 		 
		IMX179MIPI_write_cmos_sensor(0x3370, 0x5F);// (0x3370, 0x77)		 	 
		IMX179MIPI_write_cmos_sensor(0x3371, 0x17);//(0x3371, 0x2F)             
		IMX179MIPI_write_cmos_sensor(0x3372, 0x3F);             
		IMX179MIPI_write_cmos_sensor(0x3373, 0x1F);             
		IMX179MIPI_write_cmos_sensor(0x3374, 0x1F);             
		IMX179MIPI_write_cmos_sensor(0x3375, 0x17);             
		IMX179MIPI_write_cmos_sensor(0x3376, 0x5F);             
		IMX179MIPI_write_cmos_sensor(0x3377, 0x27);             
		IMX179MIPI_write_cmos_sensor(0x33C8, 0x00);             
		IMX179MIPI_write_cmos_sensor(0x33D4, 0x0C);             
		IMX179MIPI_write_cmos_sensor(0x33D5, 0xD0);             
		IMX179MIPI_write_cmos_sensor(0x33D6, 0x09);             
        ...
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]capture_setting function 1 ,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
		IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
	...
	{   //30fps		
        ...
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]capture_setting function 2 ,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
		IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
...
{		
        ...
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]normal_video_setting function,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
		IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
...
static void hs_video_setting(void)
{
	...
	//IMX179MIPI_write_cmos_sensor(0x0101, 0x00); 
	//IMX179MIPI_write_cmos_sensor(0x0103, 0x01);//SW reset		 		   
	IMX179MIPI_write_cmos_sensor(0x0202, 0x02); //0x0202, 0x09		 
	IMX179MIPI_write_cmos_sensor(0x0203, 0x68);//(0x0203, 0xcc)
	//PLL setting
	IMX179MIPI_write_cmos_sensor(0x0301, 0x05); 		 
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x030D, 0xA0); //(0x030D, 0xA2)
	IMX179MIPI_write_cmos_sensor(0x030E, 0x01);	
	IMX179MIPI_write_cmos_sensor(0x0340, 0x02);//(0x0340, 0x09)
	IMX179MIPI_write_cmos_sensor(0x0341, 0x6c); 		 
	IMX179MIPI_write_cmos_sensor(0x0342, 0x0D); 		
	IMX179MIPI_write_cmos_sensor(0x0343, 0x70);//(0x0343, 0x0D) 		 
	IMX179MIPI_write_cmos_sensor(0x0344, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0345, 0x28); 		 
	IMX179MIPI_write_cmos_sensor(0x0346, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0347, 0x20);// (0x0347, 0x00)		 
	IMX179MIPI_write_cmos_sensor(0x0348, 0x0C); 		
	IMX179MIPI_write_cmos_sensor(0x0349, 0xA7); 		 
	IMX179MIPI_write_cmos_sensor(0x034A, 0x09);// (0x034A, 0x09)		 
	IMX179MIPI_write_cmos_sensor(0x034B, 0x7F);//(0x034B, 0x9F) 		 
	IMX179MIPI_write_cmos_sensor(0x034C, 0x02); 		 
	IMX179MIPI_write_cmos_sensor(0x034D, 0x80); 		 
	IMX179MIPI_write_cmos_sensor(0x034E, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x034F, 0xE0);//(0x034F, 0xD0)		 
	IMX179MIPI_write_cmos_sensor(0x0383, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0387, 0x01); 		
	IMX179MIPI_write_cmos_sensor(0x0390, 0x02); 		 
	IMX179MIPI_write_cmos_sensor(0x0401, 0x02); 		 
	IMX179MIPI_write_cmos_sensor(0x0405, 0x14); 		 
	IMX179MIPI_write_cmos_sensor(0x3020, 0x10); 		 
	IMX179MIPI_write_cmos_sensor(0x3041, 0x15); 		 
	IMX179MIPI_write_cmos_sensor(0x3042, 0x87); 		 
	IMX179MIPI_write_cmos_sensor(0x3089, 0x4F); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x3377, 0x37);             
	IMX179MIPI_write_cmos_sensor(0x33C8, 0x00);             
	IMX179MIPI_write_cmos_sensor(0x33D4, 0x03);             
	IMX179MIPI_write_cmos_sensor(0x33D5, 0x20);             
	IMX179MIPI_write_cmos_sensor(0x33D6, 0x02);             
	IMX179MIPI_write_cmos_sensor(0x33D7, 0x58);             
	IMX179MIPI_write_cmos_sensor(0x4100, 0x0E);             
	IMX179MIPI_write_cmos_sensor(0x4108, 0x01);             
	IMX179MIPI_write_cmos_sensor(0x4109, 0x7C);
#ifdef IMX179_USE_OTP
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]hs_video_setting function,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
	IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
...
static void slim_video_setting(void)
{
	...
	//IMX179MIPI_write_cmos_sensor(0x0101, 0x00); 
	//IMX179MIPI_write_cmos_sensor(0x0103, 0x01);//SW reset		 		   
	IMX179MIPI_write_cmos_sensor(0x0202, 0x06); //0x0202, 0x09		 
	IMX179MIPI_write_cmos_sensor(0x0203, 0x0A);//(0x0203, 0xcc)
	//PLL setting
	IMX179MIPI_write_cmos_sensor(0x0301, 0x05); 		 
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x030B, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x030C, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x030D, 0x64); //(0x030D, 0xA2)
	IMX179MIPI_write_cmos_sensor(0x030E, 0x01);	
	IMX179MIPI_write_cmos_sensor(0x0340, 0x06);//(0x0340, 0x09)
	IMX179MIPI_write_cmos_sensor(0x0341, 0x0E); 		 
	IMX179MIPI_write_cmos_sensor(0x0342, 0x0D); 		
	IMX179MIPI_write_cmos_sensor(0x0343, 0x70);//(0x0343, 0x0D) 		 
	IMX179MIPI_write_cmos_sensor(0x0344, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0345, 0x1E); 		 
	IMX179MIPI_write_cmos_sensor(0x0346, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x0347, 0xE8);// (0x0347, 0x00)		 
	IMX179MIPI_write_cmos_sensor(0x0348, 0x0C); 		
	IMX179MIPI_write_cmos_sensor(0x0349, 0xB1); 		 
	IMX179MIPI_write_cmos_sensor(0x034A, 0x08);// (0x034A, 0x09)		 
	IMX179MIPI_write_cmos_sensor(0x034B, 0xB7);//(0x034B, 0x9F) 		 
	IMX179MIPI_write_cmos_sensor(0x034C, 0x05); 		 
	IMX179MIPI_write_cmos_sensor(0x034D, 0x08); 		 
	IMX179MIPI_write_cmos_sensor(0x034E, 0x03); 		 
	IMX179MIPI_write_cmos_sensor(0x034F, 0x20);//(0x034F, 0xD0)		 
	IMX179MIPI_write_cmos_sensor(0x0383, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0387, 0x01); 		
	IMX179MIPI_write_cmos_sensor(0x0390, 0x01); 		 
	IMX179MIPI_write_cmos_sensor(0x0401, 0x02); 		 
	...
	IMX179MIPI_write_cmos_sensor(0x3089, 0x4F); 		 
	IMX179MIPI_write_cmos_sensor(0x3309, 0x9A); 		 
	IMX179MIPI_write_cmos_sensor(0x3344, 0x3F);//(0x3344, 0x57)		 
	IMX179MIPI_write_cmos_sensor(0x3345, 0x1F); 		 
	IMX179MIPI_write_cmos_sensor(0x3362, 0x0A); 		 
	IMX179MIPI_write_cmos_sensor(0x3363, 0x0A); 		 
	IMX179MIPI_write_cmos_sensor(0x3364, 0x00); 		
	IMX179MIPI_write_cmos_sensor(0x3368, 0x18); 		 
	IMX179MIPI_write_cmos_sensor(0x3369, 0x00); 		 
	IMX179MIPI_write_cmos_sensor(0x3370, 0x67);// (0x3370, 0x77)		 	 
	IMX179MIPI_write_cmos_sensor(0x3371, 0x17);//(0x3371, 0x2F)             
	IMX179MIPI_write_cmos_sensor(0x3372, 0x47);             
	IMX179MIPI_write_cmos_sensor(0x3373, 0x1F);             
	IMX179MIPI_write_cmos_sensor(0x3374, 0x1F);             
	IMX179MIPI_write_cmos_sensor(0x3375, 0x17);             
	IMX179MIPI_write_cmos_sensor(0x3376, 0x77);             
	IMX179MIPI_write_cmos_sensor(0x3377, 0x27);             
	IMX179MIPI_write_cmos_sensor(0x33C8, 0x00);             
	IMX179MIPI_write_cmos_sensor(0x33D4, 0x06);             
	IMX179MIPI_write_cmos_sensor(0x33D5, 0x4A);             
	IMX179MIPI_write_cmos_sensor(0x33D6, 0x03);             
	IMX179MIPI_write_cmos_sensor(0x33D7, 0xE8);             
	IMX179MIPI_write_cmos_sensor(0x4100, 0x0E);             
	IMX179MIPI_write_cmos_sensor(0x4108, 0x01);             
	IMX179MIPI_write_cmos_sensor(0x4109, 0x7C);
#ifdef IMX179_USE_OTP
        if(ret == 0)
        {
	    LOG_INF("[IMX179_USE_OTP]slim_video_setting function,imx179_update_awb_gain\n");
	    imx179_update_awb_gain();
        }
#endif
	IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	if(SUPPORT_I2C_BUS_NUM1 == get_camera_ic_bus_num())
	{
		//i2c bus1 mean main camera,return error id
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_SET_REGISTER:
			IMX179MIPI_write_cmos_sensor(sensor_reg_data->RegAddr, sensor_reg_data->RegData);
			break;
		case SENSOR_FEATURE_GET_REGISTER:
			sensor_reg_data->RegData = IMX179MIPI_read_cmos_sensor(sensor_reg_data->RegAddr);
			break;
