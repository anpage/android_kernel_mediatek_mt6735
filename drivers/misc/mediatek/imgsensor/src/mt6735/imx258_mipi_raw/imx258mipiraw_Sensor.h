...
#define IMX258_LITEON_OTP
#define IMX258_LITEON_OTP_DEBUG
#define IMX258_LITEON_USE_WB_OTP
#define IMX258_LITEON_USE_LSC_OTP
#define IMX258_LITEON_CHECK_VENDOR_ID
#endif 
